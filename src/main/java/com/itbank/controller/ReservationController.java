...
public class ReservationController {
	...
	@GetMapping({"/reserComple", "/reserCancel", "/reserStaying"})
	public ModelAndView reservation(HttpServletRequest request) {
		...
		List<PaymentDTO> Plist = ps.selectReservation(dto.getUser_idx());
	...
	public ModelAndView booking(@PathVariable int payment_idx, HttpServletRequest request) {
	...
	public String refund(PaymentDTO pay_dto) {
		...
		return result == 1 ? "redirect:/reservation/reserComple" : "";
	}
