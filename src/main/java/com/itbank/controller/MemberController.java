...
//	로그인 
	@PostMapping("/login")
	public String login(MemberDTO user, String uri, HttpSession session, HttpServletRequest request, HttpServletResponse response) {
...
//	화면전환 
	...
	public ModelAndView memberInfo(HttpServletRequest request) {
		...
		String uri = request.getRequestURI().substring("/member/".length());
	...
	public String registCoupon(@RequestParam HashMap<String, String> map, HttpSession session) {
