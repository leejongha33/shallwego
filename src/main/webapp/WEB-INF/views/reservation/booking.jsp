...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    <link href="${cpath }/resources/css/reservation/booking.css" rel="stylesheet" type="text/css"> 
    <link href="${cpath }/resources/css/reservation/cancel_policy.css" rel="stylesheet" type="text/css"> 
            ...
            <div class="cancel_daddy2">
                <div class="cancel_mom">
                    <div class="cancel_div">
                        ...
                        <div class="cancel_div_body">
                            <div class="cancel_text">
                               <form method="POST" action="${cpath }/reservation/booking/refund">
                                  <input style="float: left; width: 30%; height: 30px;" type="password" name="cvc_number"/>
                                  <input type="hidden" name="payment_idx" value="${pay_dto.payment_idx }"/>
                                  <input style="float: right;" class="btn04" type="submit" value="전송"/>
                               </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <section class="first1_section">
                        <section class="second_section">
                            ...
                            <div class="booking1_div">
                                ...
                                <div class="booking_space2"><fmt:formatDate value="${pay_dto.payment_date }" pattern="yyyy-MM-dd"/> (서울 시간)</div>
                            </div>                            
                            <!-- <div class="booking1_div">
                                <div>
                        ...
                        <section class="second_section">
                            ...
                            <div class="booking1_div">
                                ...
                                <div class="booking_space2">
                                    <span class="booking_span1">
                                    	<fmt:formatDate value="${pay_dto.checkin }" type="both" pattern="yyyy-dd-MM"/>
                                    </span>
				  
				  					<!-- 박 -->
                                    <span class="booking_span2"></span>
                                    
                                    <span class="booking_span3">
                                    	<fmt:formatDate value="${pay_dto.checkout }" type="both" pattern="yyyy-dd-MM"/>
                                    </span>
                                </div>
                            </div>
                            <div class="booking1_div">
                        ...
                        <section class="second_section">
                            ...
                            <div class="booking_cancel1">
                                <div class="booking_cancel2">
                                    ...
                                    <div class="booking_ad2">yyyy-MM-dd 이후 취소시 <fmt:formatNumber value="${room_dto.cost_price }" pattern="#,###"/>&nbsp;원이 부과 됩니다</div>
                                </div>
                            </div>
                            <div class="booking1_div">
                                <div class="gray-f">
            ...
            <ul class="right_ul">
                <li>
                    <section class="third_section">
                        <div class="top_fsd2">
                            ...
                            <div class="booking1_div">
                                <div class="booking_space3"><h4 class="gray-f">객실 종류</h4></div>
                ...
                <li>
                    <section class="third_section">
                        ...
                        <div class="booking1_div">
                            <div class="booking_space3"><h4 class="gray-f">숙소 주소</h4></div>
                ...
                <li>
                    <section class="third_section">
                        ...
                        <div class="top_fsd4">
                            ...
                            <div class="booking_space6"><fmt:formatNumber value="${room_dto.cost_price }" pattern="#,###"/>&nbsp;원</div>
                        </div>                        
                        <div class="booking_space7 gray-f"><h5>세금 및 봉사료 포함</h5></div>
                        <div class="top_fsd3">
                            <div class=""><h4 class="gray-f">총 결제액</h4></div>
                            <div class=""><h2><fmt:formatNumber value="${room_dto.cost_price }" pattern="#,###"/>&nbsp;원</h2></div>
                        </div>
                    </section>
                </li>
            </ul>
