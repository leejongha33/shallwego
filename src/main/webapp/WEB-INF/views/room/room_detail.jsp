...
<div class="room_img_modal">
		<div class="rm_img_modal">
			...
			<div class="img_wrap">
				<div class="img">
					<img src="http://192.168.0.184/shallwego/${acc_dto.accomm_type }/${acc_dto.accomm_name }/${i.room_name }/${i.img_result[0] }"/>
					<img src="http://192.168.0.184/shallwego/${acc_dto.accomm_type }/${acc_dto.accomm_name }/${i.room_name }/${i.img_result[1] }"/>
					<img src="http://192.168.0.184/shallwego/${acc_dto.accomm_type }/${acc_dto.accomm_name }/${i.room_name }/${i.img_result[2] }"/>
				</div>
			</div>	
	...
	<section class="section">
		<div class="section-in2">
			...
			<div class="photo">
				...
				<!-- accomm_name 불러오기 -->
				<span><a class="review_link pink-f" href="">리뷰보기</a></span>
				...
				<c:forEach var="i" items="${roomList }">
					<div class="roomtype">
						<div class="room_img">
							<c:choose>
								<c:when test="${acc_dto.accomm_type == 1 }">
									<a href=""><img src="http://192.168.0.184/shallwego/${acc_dto.accomm_type }/${acc_dto.tier_number }/${acc_dto.accomm_name }/${i.room_name }/${i.img_result[0] }"></a>
								</c:when>
								<c:otherwise>
									<a href=""><img src="http://192.168.0.184/shallwego/${acc_dto.accomm_type }/${acc_dto.accomm_name }/${i.room_name }/${i.img_result[0] }"></a>
								</c:otherwise>
							</c:choose>
						</div>
